...
const seedLessonsAndQuizzes = async () => {
  try {
    ...
    if (lessonCount === 0) {
      ...
      console.log('✅ 15 Lessons seeded!');
    } else {
      console.log(`ℹ️ Lessons already exist (${lessonCount}), skipping.`);
    }
    ...
    if (quizCount === 0) {
      ...
      console.log('✅ 10 Quizzes seeded!');
    } else {
      console.log(`ℹ️ Quizzes already exist (${quizCount}), skipping.`);
    }
